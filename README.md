...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-27 12:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9cdd4e9c-7956-4f6e-b6bb-ca538817b957.git
$ cd 9cdd4e9c-7956-4f6e-b6bb-ca538817b957
```
